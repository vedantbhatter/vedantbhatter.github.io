...
const config = {
  github: {
    username: 'vedantbhatter', // Your GitHub org/user name. (Required)
  ...
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'vedantbhatter.github.io',
    phone: '',
    email: 'vedantbhatter@berkeley.edu',
  },
  resume: {
    fileUrl:
  ...
  footer: `All rights reserved © ${new Date().getFullYear()} - Vedant Bhatter`,
};
